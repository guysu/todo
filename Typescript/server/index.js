...
var ctrl = require("./server.ctrl");
var app = express();
var PORT = process.env.PORT || 80;
app.use(cookieParser());
app.use(express.static(path.join(__dirname + "/../client/public/")));
app.use(express.json());
var getUserID = function (req) { return req.cookies.userID; };
app.get("/todos", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userID, allTodos;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userID = getUserID(req) || uuid.v4();
                return [4 /*yield*/, ctrl.getAllUserTodos(userID)];
            case 1:
                allTodos = _a.sent();
...
app.put("/todos/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userID, taskID, _a, checked, title;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                userID = getUserID(req);
                taskID = req.params.id;
                _a = req.body, checked = _a.checked, title = _a.title;
                return [4 /*yield*/, ctrl.editTodo(userID, taskID, checked, title)];
            case 1:
                if (_b.sent()) {
                    res.sendStatus(200);
                }
